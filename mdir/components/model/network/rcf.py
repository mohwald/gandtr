#
# Modified architecture from https://github.com/yun-liu/RCF-PyTorch/blob/master/models.py
# which is released under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0
# International Public License for NonCommercial use only. Any commercial use should get
# formal permission first (Email: yun.liu@vision.ee.ethz.ch).
#
# Changes summary:
# (1) the output of the RCF network is the batch of final edge maps,
# (2) adds additional attributes providing processing information for mdir.
#
...
class RCF(nn.Module):
    ...
    def forward(self, x, no_sigmoid=False, features=False, interpolate=False):
        ...
        return fuse if no_sigmoid else torch.sigmoid(fuse)
