...
from . import cirtorch_datasets, tuple_datasets, domain_datasets
...
DATASET_LABELS = {
    "ImageList": tuple_datasets.ImageListDataset,
    "InferImageList": tuple_datasets.InferImageListDataset,
    ...
    "RandomDomainsPair": domain_datasets.RandomDomainsPairDataset,
    "CirTuples": cirtorch_datasets.cir_tuples_dataset,
    "CirDiverseAnchors": cirtorch_datasets.cir_diverse_anchors_dataset,
