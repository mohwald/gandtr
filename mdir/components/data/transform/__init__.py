...
TRANSFORMS = {
    ...
    "square_crop": augmentation_transforms.SquareCrop,
    "downscale": augmentation_transforms.Downscale,
    "scalecrop": augmentation_transforms.RandomScaleCrop,
    "centerscalecrop": augmentation_transforms.CenterScaleCrop,
    ...
    "apply_colorspaceclahe": photometric_transforms.ApplyColorspaceClahe,
